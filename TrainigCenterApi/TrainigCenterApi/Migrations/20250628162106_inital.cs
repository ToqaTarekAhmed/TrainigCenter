    ...
    public partial class inital : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoursePriceHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CoursePriceHistories_TrainerCourses_TrainerCourseId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CoursePriceHistoryId = table.Column<int>(type: "int", nullable: false),
                    TrainerCourseId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseRegistrations_CoursePriceHistories_CoursePriceHistoryId",
                        column: x => x.CoursePriceHistoryId,
                        principalTable: "CoursePriceHistories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CourseRegistrations_Trainees_TraineeId",
                        column: x => x.TraineeId,
                        principalTable: "Trainees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseRegistrations_TrainerCourses_TrainerCourseId",
                        column: x => x.TrainerCourseId,
                        principalTable: "TrainerCourses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Certificates_CourseRegistrations_CourseRegistrationId",
                        column: x => x.CourseRegistrationId,
                        principalTable: "CourseRegistrations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Feedbacks_CourseRegistrations_CourseRegistrationId",
                        column: x => x.CourseRegistrationId,
                        principalTable: "CourseRegistrations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Certificates_CourseRegistrationId",
                table: "Certificates",
                column: "CourseRegistrationId");

            migrationBuilder.CreateIndex(
                name: "IX_CoursePriceHistories_TrainerCourseId",
                table: "CoursePriceHistories",
                column: "TrainerCourseId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseRegistrations_CoursePriceHistoryId",
                table: "CourseRegistrations",
                column: "CoursePriceHistoryId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseRegistrations_TraineeId",
                table: "CourseRegistrations",
                column: "TraineeId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseRegistrations_TrainerCourseId",
                table: "CourseRegistrations",
                column: "TrainerCourseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Feedbacks_CourseRegistrationId",
                table: "Feedbacks",
                column: "CourseRegistrationId");
